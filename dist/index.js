...
`);
      ...
      commitMetadata: committish => {
        ...
        const authorDate = /* @__PURE__ */ new Date(+(lines[1] + '000'));
        const committerDate = /* @__PURE__ */ new Date(+(lines[2] + '000'));
        return {
      ...
      logBetween: (baseCommittish, finalCommittish) => {
        ...
        return commits.map(commit => {
          ...
          return {
            ...
            authorName: props[2],
            authorEmail: props[3],
            authorDate: /* @__PURE__ */ new Date(+(props[4] + '000')),
            committerName: props[5],
            committerEmail: props[6],
            committerDate: /* @__PURE__ */ new Date(+(props[7] + '000')),
            rawBody: props[8],
            commitNotes: props[9]
          };
        });
  ...
  'src/version.js'(exports2, module2) {
    ...
    var commitPatterns = {
      major: [
        ...
        // e.g. +semver:breaking, +semver.major
        /BREAKING CHANGES?:?/
        // e.g. BREAKING CHANGE:, BREAKING CHANGES
      ],
      minor: [
        /\+semver:\s*(feature|minor)/i,
        // e.g. +semver:feature, +semver:minor
        /feat\([^)]*\):\s/,
        // e.g. feat(area): something, feat(): something
        /feature\([^)]*\):\s/,
        // e.g. feature(area): something, feature(): something
        /^feat:\s.+/m,
        // e.g. feat: something (at the beginning of a line)
        /^feature:\s.+/m
        // e.g. feature: something (at the beginning of a line)
      ]
    };
